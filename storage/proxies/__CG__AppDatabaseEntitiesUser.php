 ...
 */
class User extends \App\Database\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
  ...
  'userGuest' => NULL,
    ...
    {
        unset($this->createdAt, $this->updatedAt, $this->userGuest);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'createdAt', 'updatedAt', 'userGuest', 'active', 'email', 'emailVerifiedAt', 'firstName', 'lastName', 'password', 'type', 'userId', 'rememberToken'];
        }

        return ['__isInitialized__', 'active', 'email', 'emailVerifiedAt', 'firstName', 'lastName', 'password', 'type', 'userId', 'rememberToken'];
    }
    ...
    public function getEmailVerifiedAtAsString(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmailVerifiedAtAsString', []);

        return parent::getEmailVerifiedAtAsString();
    }
     ...
     * {@inheritDoc}
     */
    public function setCreatedAt(\DateTimeInterface $createdAt): \App\Database\Entities\User
    {
     ...
     * {@inheritDoc}
     */
    public function setRememberToken($value): \App\Database\Entities\User
    {
     ...
     * {@inheritDoc}
     */
    public function setUpdatedAt(\DateTimeInterface $updatedAt): \App\Database\Entities\User
    {
